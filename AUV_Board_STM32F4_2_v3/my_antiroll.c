...
/* Private define ------------------------------------------------------------*/
		...
		*/
			#define UARENC_TIM_IT										TIM4
			#define UARENC_TIM_IT_CLK								RCC_APB1Periph_TIM4
			#define UARENC_TIM_IT_CLK_Cmd						RCC_APB1PeriphClockCmd
			#define UARENC_TIM_IT_IRQn							TIM4_IRQn
			#define UARENC_TIM_IT_IRQHandler				TIM4_IRQHandler
...
/** 
		...
		*/
			...
			#define DIR_R_PIN										GPIO_Pin_9								//HIGH			LOW			LOW			HIGH
			#define DIR_L_PIN										GPIO_Pin_10								//LOW				HINGH		LOW			HIGH
																																		//CW				CCW			STOP		BURN
...
/*
	For PID
	*/
static float error, error1=0, error2=0, value=0;
